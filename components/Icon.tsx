...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  name: string; // This could be used for dynamic icon loading if you had a map
  size?: number | string;
}
...
const icons: Record<string, React.ReactNode> = {
  ...
  store: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 2L3 8v12h18V8L12 2zm0 0v5m0 10v-5m-5 5h10m-9-5H3m18 0h-4m-4 0v-5m-5 5V8M8 8l4-3 4 3" />, // Simplified store
